                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-3">
                                                    <img class="thumb" src="{{ $item["produit"]->image_path }}"
                                                        alt="Clavier">
                                                    <div>
                                                        <div class="fw-semibold">{{ $item["produit"]->nom }}</div>
                                                        <div class="muted small">{{ $item["produit"]->categorie->nom }}</div>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    <button class="btn btn-outline-accent" type="button" data-action="dec">−</button>
                                                    <input class="form-control text-center" type="number" min="1" value="{{ $item["quantite"] }}" data-qty>
                                                    <button class="btn btn-outline-accent" type="button" data-action="inc">+</button>
                                                </div>
                                            </td>
                                            <td class="price fw-semibold" data-line-total>{{ $item["totalProduit"] }}</td>
                                            <td class="text-end">
