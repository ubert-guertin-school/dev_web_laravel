...
$(document).ready(() => {
  ...
  const forms = document.querySelectorAll('.needs-validation-profile');
  const passwordForms = document.querySelectorAll('.needs-validation-password');

  addValidationToForm(forms);
  addValidationToForm(passwordForms);
